package io.nbe.test.config.social;

import io.nbe.test.repository.SocialUserConnectionRepository;
import io.nbe.test.repository.CustomSocialUsersConnectionRepository;
import io.nbe.test.security.social.CustomSignInAdapter;
